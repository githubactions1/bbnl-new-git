...
exports.generatexmlf = function (caf) {
    ...
    var count = 0;
    var finlres = [];
	console.log("coming response for caf in html", caf);
	console.log("coming response for caf in html flag : ", caf[0]['flag']);
	if ( caf[0]['flag'] == 2 ) {
        ...
        caf.filter(element => {
            if (element.srnlo === "DSN") {
                ...
                fs.readFile(dsnw_tmplt, 'utf8', function (err, data) {
