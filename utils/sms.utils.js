...
exports.sendNotifySMS = function (phoneNo, smsMsg, ntfcn_cgry_id, callback, tmplt_id) {
    ...
    //}
	//var postData = {
		//"username":"fibernet.sms",
		//"pin":"V@7e%233Ty",
		//"signature":"APFIBR",
		//"dlt_entity_id":"1101379100000041570",
		//"message":smsMsg,
		//"mnumber":"91"+phoneNo,
		//"dlt_template_id":tmplt_id
	//}
	//console.log("postdata", postData);
	var fnm = "sendNotifySMS";
    var options = {
        method: 'get',
		rejectUnauthorized: false,
        //body: postData, // Javascript object
        //json: true, // Use,If you are sending JSON data
        //url: 'https://bss.apsfl.co.in/apiv1/alerts/notifications/sms/send/simple'
		 url : 'https://smsgw.sms.gov.in/failsafe/MLink?username=fibernet.sms&pin=V@7e%233Ty&message='+smsMsg+'&mnumber=91'+phoneNo+'&signature=APFIBR&dlt_entity_id=1101379100000041570&dlt_template_id='+tmplt_id
    }
    var results = '';
    request(options, function (err, res, body) {
		//console.log(res);
		...
		console.log("err, result in request", err, results);
...
* Arguments     : callback function
* History   
* 28/02/2022    ** Srujana Mulagada  ** Initial Code
******************************************************************************/
exports.newsendNotifySMS = function (phoneNo, smsMsg, callback, tmplt_id) {
    console.log("smsMsg sendSMS");
    console.log(smsMsg, phoneNo);
...
* 10/06/2020    ** Srujana Mulagada  ** Initial Code
******************************************************************************/
exports.callbacksendNotifySMS = function (phoneNo, smsMsg, ntfcn_cgry_id, callback, tmplt_id) {
    console.log("smsMsg sendSMS");
    console.log(smsMsg, phoneNo);
