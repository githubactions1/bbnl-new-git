...
// mail.secure = false;
// console.log(mailDt);
var mailTr = nodemailer.createTransport(smtpTransport(mailDt));
...
* Controller     : sendDSMS
* Parameters     : req,res()
* Description    : To send sms using glits
* Change History :
* 07/09/2016    - Sony Angel - Initial Function
*
***************************************************************************************/
exports.sendDSMS = function (toNumber, message, callback) {
