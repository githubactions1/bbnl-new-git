...
cafRtr.get('/EntrpeCstmrillibbTyp', checkUser.hasToken, EntrpeCstmrTypCtrl.getEntrpeCstmrillibbTypCtrl);
...
cafRtr.get('/ent_caf_details/:caf_id', checkUser.hasToken, CafCtrl.getentcafdetailsCtrl);
...
cafRtr.post('/getbbnldt', checkUser.hasToken, CafCtrl.getbbnlcafdtls);
cafRtr.post('/getgoidt', checkUser.hasToken, CafCtrl.getgoicafdtlCtrl);
cafRtr.post('/getdtfrcmplnts', checkUser.hasToken, CafCtrl.get_cafdtlscmplnts);
cafRtr.post('/getdtcountfrcmplnts', checkUser.hasToken, CafCtrl.getdtcountfrcmplntsCtrl);
cafRtr.post('/getdtfrIms', checkUser.hasToken, CafCtrl.get_cafdtlsfrIms);
cafRtr.post('/getblkdt', checkUser.hasToken, CafCtrl.get_cafblkdtls);
cafRtr.post('/getdtlsusrsme', checkUser.hasToken, CafCtrl.get_dtlsusrsme);
...
cafRtr.get('/aadhaar/:u_id', aadhaarCtrl.get_newaadhaarDtlsCtrl);

cafRtr.post('/newaadhaar', checkUser.hasToken, aadhaarCtrl.get_newaadhaarDtlsCtrl);
...
cafRtr.get('/customer/invoices/addons/:id', checkUser.hasToken,CafCtrl.getcafaddoninvceDtls); 
...
cafRtr.get('/customer/invoices/addons/charges/:id', checkUser.hasToken,CafCtrl.getcafaddonsInvoiceChargesDtls);
...
// get pop details by agent id apsfl or bbnl
cafRtr.get('/getPopByAgntId/:id/:apsfBbnl', checkUser.hasToken , CafCtrl.getapsflBbnlPopDtls);
...
cafRtr.post('/newuploadCafKyc', checkUser.hasToken, CafCtrl.newuploadCafKycCtrl);
cafRtr.post('/getcaflmoKycDtls', checkUser.hasToken, CafCtrl.getcaflmoKycDtlsCtrl);
//cafRtr.post('/sbscruploadCafKyc', checkUser.hasToken, CafCtrl.sbscruploadCafKycCtrl);
cafRtr.post('/newgetcaflmoKycDtls', checkUser.hasToken, CafCtrl.newgetcaflmoKycDtlsCtrl);
cafRtr.post('/uploadSelfCafKyc', checkUser.hasToken, CafCtrl.uploadSelfCafKyc);
cafRtr.post('/newuploadSelfCafKyc', checkUser.hasToken, CafCtrl.newuploadSelfCafKyc);
...
cafRtr.post('/lmodetailsformsowise', checkUser.hasToken , CafCtrl.getLmolisrforMSOCtrl);
