...
exports.createUsers = function (user, clnt_id, tnts, data, callback) {
    ...
    dbutil.execQuery(sqldb.MySQLConPool, QRY_TO_EXEC, cntxtDtls, user, function (err, results) {
        ...
        for (var i = 0; i < tnts.length; i++) {
            ...
            dbutil.execQuery(sqldb.MySQLConPool, QRY_TO_EXEC1, cntxtDtls, user, function (err, results) {
 ...
 * Arguments     : callback function
 ******************************************************************************/
exports.sendOtpMdl = function (data) {
 ...
 * Arguments     : callback function
 ******************************************************************************/
exports.postAgntVldtOtpMdl = function (data) {
 ...
 * Function      : cafdtlsget
 ******************************************************************************/
exports.cafdtlsgetMdl = function (id) {

    var QRY_TO_EXEC = `select substring(c.onu_srl_nu,1,3)as srnlo,c.onu_srl_nu as cpeslno,r.caf_id,concat('+91',REPLACE(p.phne_nu,'-','')) as phoneno,p.pswrd_txt as passwrd, CONCAT('+91',REPLACE(p.phne_nu,'-',''),'@vskp.apsflims.in') as username  
 ...
 ******************************************************************************/
exports.cafdtlsMultiMdl = function (frmdt, todt) {
 ...
 ******************************************************************************/
exports.getLMOContactsMdl = function (agent_id) {
