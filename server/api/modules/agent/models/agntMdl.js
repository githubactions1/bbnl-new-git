...
* Arguments      : callback function
******************************************************************************/
exports.getLmoMdl = function (user) {
    var fnm = "getLmoMdl"
	...
	var QRY_TO_EXEC = ` SELECT  ROW_NUMBER() OVER ( ORDER BY a.agnt_id) as s_no,agnt_id
                        ...
                        JOIN prtnrs_lst_t as ac on a.agnt_ctgry_id=ac.prtnr_id  
                        left JOIN ste_lst_t as s on a.ofce_ste_id=s.ste_id                   
                        left JOIN vlge_lst_t as v on (a.ofce_vlge_id=v.vlge_nu or a.ofce_vlge_id=v.vlge_id) and v.mndl_id = a.ofce_mndl_id AND v.dstrt_id = a.ofce_dstrt_id
                        left JOIN mndl_lst_t m ON m.mndl_nu = v.mndl_id AND v.dstrt_id = m.dstrt_id
                        left JOIN dstrt_lst_t d ON d.dstrt_id = v.dstrt_id
                        where ac.prtnr_nm = 'LMO' group by agnt_id`;
...
* Arguments      : callback function
******************************************************************************/
exports.selectAgentbumsoMdl = function (id, user) {
    var fnm = "selectAgentbumsoMdl"
...
* Arguments      : callback function
******************************************************************************/
exports.getCrntMnthCntsMdl = function (id, user) {
    var fnm = "getCrntMnthCntsMdl"
...
* Arguments      : callback function
******************************************************************************/
exports.getPrvsMnthCntsMdl = function (id, user) {
    var fnm = "getPrvsMnthCntsMdl"
    var QRY_TO_EXEC = `SELECT lmo_agnt_id,a.agnt_cd,a.agnt_nm,a1.agnt_nm AS mso_nm,a.ofce_mbl_nu,a.ofce_cntct_nm,dstrt_id,dstrt_nm,oprtn_mm,oprtn_yr,
    lmo_prv_blnce_at,lmo_clctd_at,add_on_chrge_at,voip_chrge_at,crdt_at,dsptd_at
    ,caf_ct,prtd_caf_ct,pd_caf_ct,bx_only_caf_ct,nt_pd_caf_ct,
...
* Arguments      : callback function
******************************************************************************/
exports.getCpeCntsMdl = function (id, user) {
    var fnm = "getCpeCntsMdl"
...
* Arguments      : callback function
******************************************************************************/
exports.cafcountbymsoMdl = function (id, user) {
    var fnm = "cafcountbymsoMdl"
...
* Arguments      : callback function
******************************************************************************/
exports.selectAgentsrvng_astsMdl = function (id, user) {
    var fnm = "selectAgentsrvng_astsMdl"
...
* Arguments      : callback function
******************************************************************************/
exports.selectAgentdcmntsMdl = function (id, user) {
    var fnm = "selectAgentdcmntsMdl"
...
* Arguments      : callback function
******************************************************************************/
exports.selectAgntBnkMDl = function (id, user) {
    var fnm =  "selectAgntBnkMDl"
...
* Arguments      : callback function
******************************************************************************/
exports.selectAreasrvngMdl = function (id, user) {
    var fnm = "selectAreasrvngMdl"
...
exports.updateAgentSrvingAreaMdl = function (id, data, user) {
    var fnm = "updateAgentSrvingAreaMdl"
    // console.log(id)
    // console.log(data);
    // return;
...
exports.updateAgentSrvingAssetMdl = function (id, data, user) {
    var fnm ="updateAgentSrvingAssetMdl"
    // console.log(id)
    // console.log(data);
    // return;
...
* Arguments      : callback function
******************************************************************************/
exports.delAgentMdl = function (id, user) {
    // console.log(id)
    var fnm = "delAgentMdl"
...
* Arguments      : callback function
******************************************************************************/
exports.rejAgentMdl = function (id, user) {
    var fnm = "rejAgentMdl"
    // console.log(id)
...
* Arguments      : callback function
******************************************************************************/
exports.unrejAgentMdl = function (id, user) {
    var fnm = "unrejAgentMdl"
    // console.log(id)
...
* Arguments      : callback function
******************************************************************************/
exports.getPortConnslotsMdl = function (agnt_id, user) {
    var fnm = "getPortConnslotsMdl"
...
* Arguments      : callback function
******************************************************************************/
exports.getAgntDtlsMdl = function (agnt_id, user) {
...
* Arguments      : callback function
******************************************************************************/
exports.getAgntDtlsCntsMdl = function (agnt_id, user) {
    var fnm = "getAgntDtlsCntsMdl"
...
* Arguments      : callback function
******************************************************************************/
exports.getPackAggrmntMdl = function (agnt_id, user) {
    var fnm = "getPackAggrmntMdl"
...
* Arguments      : callback function
******************************************************************************/
exports.getAgentByIdMdl = function (agnt_id, user) {

    var fnm = "getAgentByIdMdl"
    // let dtls = data.data
...
* Arguments      : callback function
******************************************************************************/
exports.getAgentSrvArsByIdMdl = function (agnt_id, user) {
    var fnm = "getAgentSrvArsByIdMdl"
...
* Arguments      : callback function
******************************************************************************/
exports.getAgentSrvAsrtByIdMdl = function (agnt_id, user) {
    var fnm = "getAgentSrvAsrtByIdMdl"
...
* Arguments      : callback function
******************************************************************************/
exports.getAgentSbStnsByIdMdl = function (agnt_id, user) {
    var fnm = "getAgentSbStnsByIdMdl"
...
* Arguments      : callback function
******************************************************************************/
exports.getAgentDcmntsByIdMdl = function (agnt_id, user) {
    var fnm = "getAgentDcmntsByIdMdl"
...
* Arguments      : callback function
******************************************************************************/
exports.getAgentBnkByIdMdl = function (agnt_id, user) {

    var fnm = "getAgentBnkByIdMdl"
    // let dtls = data.data
...
* Arguments      : callback function
******************************************************************************/
exports.get_districtsMdl = function (user) {
...
exports.get_agent_districtsMdl = function (user) {
    var fnm = "get_agent_districtsMdl"
...
* Arguments      : callback function
******************************************************************************/
exports.get_substationsMdl = function (districtID, user) {
    var fnm = "get_substationsMdl"
...
* Arguments      : callback function
******************************************************************************/
exports.get_mandalMdl = function (substnID, user) {
    var fnm = "get_mandalMdl"
...
* Arguments      : callback function
******************************************************************************/
exports.getMsoMdl = function (user) {
    var fnm = "getMsoMdl"
...
* Arguments      : callback function
******************************************************************************/
exports.getSbStnsLstByAgntIdMdl = function (agntId, user) {
    var fnm = "getSbStnsLstByAgntIdMdl"
...
* Arguments      : callback function
******************************************************************************/
exports.get_olts_portsMdl = function (agntID, user) {
    var fnm = "get_olts_portsMdl"
...
* Arguments      : callback function
******************************************************************************/
exports.getDocTypsMdl = function (user) {
    var fnm = "getDocTypsMdl"
...
* Arguments      : callback function
******************************************************************************/
exports.get_mandalsLstMdl = function (districtID, user) {
    var fnm = "get_mandalsLstMdl"
    dst=``;
    if(districtID > 0){
...
exports.get_agnet_mandalsLstMdl = function (user,districtID) {
    var fnm = "get_agnet_mandalsLstMdl"
    if(user.usr_ctgry_ky>0){
...
exports.get_agnt_vlgeListMdl = function (user, mndl_id, dsrtct_id) {
    ...
    if(user.usr_ctgry_ky>0){
		...
		JOIN vlge_lst_t v ON (v.vlge_id = a.ofce_vlge_id or v.vlge_nu = a.ofce_vlge_id) and v.mndl_id = a.ofce_mndl_id AND v.dstrt_id = a.ofce_dstrt_id
...
* Arguments      : callback function
******************************************************************************/
exports.get_oltDetailsMdl = function (districtID, mandalID, user) {
    var fnm = "get_oltDetailsMdl"
    var QRY_TO_EXEC = `
    ...
    left join caf_dtl_t as c on c.olt_id=o.olt_id
     where s.dstrct_id =${districtID} and s.mndl_id=${mandalID} and o.apsfl_bbnl=3
    GROUP BY o.olt_id
    order by o.olt_id`;
    // console.log("########################################################");
    // console.log(QRY_TO_EXEC);
...
* Arguments      : callback function
******************************************************************************/
exports.get_portWiseOltDetailsMdl = function (data, user) {
    var fnm = "get_portWiseOltDetailsMdl"
    var QRY_TO_EXEC = `
...
* Arguments      : callback function
******************************************************************************/
exports.get_tenantListMdl = function (data, user) {
    var fnm = "get_tenantListMdl"
...
exports.insert_portToAgentMdl = function (data, user, callback) {
    ...
    for (var k = 0; k < data.length; k++) {
        ...
        console.log(QRY_TO_EXEC)
        dbutil.execQuery(sqldb.MySQLConPool, QRY_TO_EXEC, cntxtDtls, user,fnm, (error, result) => {
            count++
...
exports.postAgntEnrlmntDtlsMdl = function (data, user) {
    var fnm = "postAgntEnrlmntDtlsMdl"
...
* Arguments      : callback function
******************************************************************************/
exports.getAllAgentsMdl = function (value, user) {
    var fnm = "getAllAgentsMdl"
...
* Arguments      : callback function
******************************************************************************/
exports.getAllAgentsByCtgryMdl = function (value, id, user) {
    var fnm = "getAllAgentsByCtgryMdl"
    if(id == 'null'){
...
* Arguments      : callback function
******************************************************************************/
exports.getAllEnrldAgntsMdl = function (user) {
    var fnm = "getAllEnrldAgntsMdl"
...
* Arguments      : callback function
******************************************************************************/
exports.getAllEnrlRejectMdl = function (user) {
    var fnm = "getAllEnrlRejectMdl"
    var QRY_TO_EXEC = `SELECT  ROW_NUMBER() OVER ( ORDER BY a.agnt_id DESC) as s_no,agnt_id,agnt_nm,a.agnt_ctgry_id,ac.prtnr_nm,prtnr_cd,a.enrlt_nu,
    s.ste_nm as ofc_ste_nm,d.dstrt_nm as ofc_dstrct_nm,m.mndl_nm as ofc_mndl_nm,a.ofce_mbl_nu,v.vlge_nm as ofc_vlg_nm,
    pstl_rgstn_nu,DATE_FORMAT(pstl_exprn_dt,'%d-%m-%Y') as date,pstl_exprn_dt,DATE_FORMAT(a.i_ts,'%d-%m-%Y') AS enrl_dt,
    a.ofce_vlge_id,a.ofce_dstrt_id,a.ofce_mndl_id,a.brnch_vlge_id,a.brnch_dstrt_id,a.brnch_mndl_id
...
exports.initialPymntAmtInsrtMdl = function (agnt_id, user) {
    var fnm = "initialPymntAmtInsrtMdl"
...
* Arguments      : callback function
******************************************************************************/
exports.getMsoLmoDtlsMdl = function (msoid, user) {
    var fnm = "getMsoLmoDtlsMdl"
...
* Arguments      : callback function
******************************************************************************/
exports.getMsoDtlsByAdhrMblMdl = function (data, user) {
    var fnm = "getMsoDtlsByAdhrMblMdl"
    var wherecond = ``;
...
* Arguments      : callback function
******************************************************************************/
exports.updateAgntDtlsByRegMdl = function (data, user) {
    var fnm = "updateAgntDtlsByRegMdl"
...
exports.getMnthlyMSOCollectionsMdl = function (data, user) {
    var fnm = "getMnthlyMSOCollectionsMdl"
...
* Arguments      : callback function
******************************************************************************/
exports.insrtUsrRlePermsMdl = function (data, user) {
    var fnm = "insrtUsrRlePermsMdl"
