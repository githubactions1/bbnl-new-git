...
exports.getEntrpeCstmrSubTypMdl = (user,callback) => {
    var fnm= "getEntrpeCstmrSubTypMdl"
     ...
     var QRY_TO_EXEC = `SELECT  ROW_NUMBER() OVER ( ORDER BY entrpe_cstmr_sub_typ_lst_t.entrpe_sub_type_id) sno, entrpe_cstmr_typ_lst_t.entrpe_type_nm,entrpe_cstmr_sub_typ_lst_t.* FROM entrpe_cstmr_sub_typ_lst_t  JOIN entrpe_cstmr_typ_lst_t On entrpe_cstmr_typ_lst_t.entrpe_type_id = entrpe_cstmr_sub_typ_lst_t.entrpe_type_id where entrpe_cstmr_sub_typ_lst_t.a_in = 1 ORDER BY entrpe_cstmr_sub_typ_lst_t.entrpe_sub_type_id ASC;` 
...
exports.getEntrpeCstmrSubTypByIdMdl = (id,user,callback) => {
    ...
    var QRY_TO_EXEC = `SELECT entrpe_sub_type_id,entrpe_type_id,entrpe_sub_type_nm,a_in 
                        FROM entrpe_cstmr_sub_typ_lst_t 
                        WHERE a_in = 1 AND entrpe_sub_type_id= ${id}; `;
...
*
******************************************************************************/
exports.get_EntCstmrSubTypByIdMdl = (id,user,callback) => {
    var fnm = "get_EntCstmrSubTypByIdMdl"
    var QRY_TO_EXEC = `SELECT entrpe_sub_type_id,entrpe_type_id,entrpe_sub_type_nm,a_in 
                        FROM entrpe_cstmr_sub_typ_lst_t 
...
exports.insrtEntrpeCstmrSubTypMdl = (data,user,callback) => {
    ...
    var QRY_TO_EXEC = `INSERT INTO entrpe_cstmr_sub_typ_lst_t(entrpe_type_id,entrpe_sub_type_nm,a_in,i_ts,crte_usr_id) 
                        VALUES(${data.entrpe_type_id},'${data.entrpe_sub_type_nm}',1,CURRENT_TIMESTAMP(),${user.mrcht_isr_id})`;
