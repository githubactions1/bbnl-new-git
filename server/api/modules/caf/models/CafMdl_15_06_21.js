...
exports.agntvlgsMdl = (mndl_id, distrct_id, user, caf_id, callback) => {
	...
	if(user.usr_ctgry_ky == 103001646){
		var QRY_TO_EXEC = `SELECT v.vlge_nu,v.vlge_id,v.vlge_nm from agnt_lst_t a join vlge_lst_t v on v.vlge_id=a.ofce_vlge_id WHERE v.mndl_id=${mndl_id} and v.dstrt_id=${distrct_id} and agnt_id=${user.usr_ctgry_ky}`;
	} else {
