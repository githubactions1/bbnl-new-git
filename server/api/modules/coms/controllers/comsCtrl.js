...
/**************************************************************************************
* Controller     : unbilledinformation
* Parameters     : None
* Description    : 
* Change History :
* 10/02/2020    - Sravani Machina - Initial Function
***************************************************************************************/
exports.unbilledinformation = (req, res) => {
     var fnm = "unbilledinformation";
 
     log.info(`In ${fnm}`, 0, cntxtDtls);
     let check = req.query.nwSubscriberCode;
     log.message("INFO", cntxtDtls, 100, `Getting Data Of ${check}`); 
     comsmdl.unbilledinformationMdl(check)
         .then((results) => {
              console.log(results)
