...
@Component({
  selector: 'app-suspend-pending-list-view',
  templateUrl: './suspend-pending-list-view.component.html',
  styleUrls: ['./suspend-pending-list-view.component.scss']
})
export class SuspendPendingListViewComponent implements OnInit {
  ...
  sdeMnuLdr = false;
  lmoColumnDefs = [];
  getHeaderDtls = function (): any { return { 'title': "Suspend Pending List", 'icon': 'people_outline' }; };
  msoLmoDtls: any;
  ...
  suspendlstView(): any {
    this.loading = true;
    const cmprte = `lmoprepaid/listsuspendpending`;
  ...
  //     {
  //       this.crdsrv.create(data, "caf_operations/prpdsuspension_pending").subscribe((res) => {
