...
@Component({
  selector: 'app-previousday-complaints',
  templateUrl: './previousday-complaints.component.html',
  styleUrls: ['./previousday-complaints.component.scss']
})
export class PreviousdayComplaintsComponent implements OnInit {
    ...
    getHeaderDtls = function (): any { return { 'title': "View Previous Day Complaints List", 'icon': 'people_outline' }; };
    msoLmoDtls: any;
    complaintsview: any;
  ...
  ngOnInit() {
    this.prevousdaycomplaintLstview();
  }

  prevousdaycomplaintLstview(): any{
    this.loading = true;
    const cmprte = `subscriberApp/prvsthisdaytckts/4/0`;
