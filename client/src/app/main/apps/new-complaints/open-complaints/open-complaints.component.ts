...
@Component({
  ...
  styleUrls: ['./open-complaints.component.scss']
})
export class OpenComplaintsComponent implements OnInit {
    ...
    getHeaderDtls = function (): any { return { 'title': "Open Complaints List", 'icon': 'people_outline' }; };
    msoLmoDtls: any;
    complaintsview: any;
  ...
  //   }
    ...
    getcomplaintLst(): any{
      this.loading = true;
      const cmprte = `subscriberApp/OCCIssueByCatgryOpen/0`;
