...
@Component({
  selector: 'app-close-complaints',
  templateUrl: './close-complaints.component.html',
  styleUrls: ['./close-complaints.component.scss']
})
export class CloseComplaintsComponent implements OnInit {
    ...
    getHeaderDtls = function (): any { return { 'title': "Close Complaints List", 'icon': 'people_outline' }; };
    msoLmoDtls: any;
    complaintsview: any;
  ...
  //   }
    ...
    getcomplaintLst(): any{
      this.loading = true;
      const cmprte = `subscriberApp/OCCIssueByCatgryClose/0`;
