...
@Component({
  selector: 'app-complaints-subcrbapp',
  templateUrl: './complaints-subcrbapp.component.html',
  styleUrls: ['./complaints-subcrbapp.component.scss']
})
export class ComplaintsSubcrbappComponent implements OnInit {
    ...
    getHeaderDtls = function (): any { return { 'title': "View subscribe App Complaint List", 'icon': 'people_outline' }; };
    msoLmoDtls: any;
    complaintsview: any;
    ...
    getcomplaintLst(): any{
      this.loading = true;
      const cmprte = `subscriberApp/countcompstatus/0`;
