...
@Component({
  selector: 'app-erpTmpltTyp',
  templateUrl: './erpTmpltTyp.component.html',
  styleUrls: ['./erpTmpltTyp.component.scss']
})
export class ErptmplttypComponent implements OnInit {
  columnDefs:any;
  gridData:any;
  initdata:any;
  gridApi;
  permissions;
   ...
   public fields: any[] = [
   { type: 'pk',name: 'tmple_type_id',label: 'Template type Identifier',isCustom:false,customData:{},required: false,hidden:true },
   
    { type: 'text',name: 'tmple_type_nm',label: 'Template type name',isCustom:false,customData:{"route":null,"input_key":null,"key":null,"label_key":null,"label":null,"table":null},value: '',required: false,hidden:false },
  ];
  public formDetails : any ={ 
    fnctns  :{},
    apis    :{ "sel_url":"erp/erpTmpltTyp",
               "upd_url":"erp/erpTmpltTyp/:tmple_type_id",
               "ins_url":"erp/erpTmpltTyp",
               "del_url":"erp/erpTmpltTyp/:tmple_type_id"},
    initdata:{ },
    fields  :this.fields,
    key_field:["tmple_type_id"],
    stngs   :{ "style" :"mat",
                "saveBtn":true,
                "saveAsBtn":false,
                "closeBtn":true,
                "model_style":"right",
                "form_title":" ERP Template Types",
                "deleteBtn":false,
                "show_lables":false,
                "oper_mode":"new"
  ...
  user: any = {
    ...
    'perm_url': 'user/permissions/ERP Template Types'
  };
    ...
    this.crdsrv.get(this.formDetails.apis.sel_url).subscribe((res) => {
      if (res['status'] == 200) {
        ...
        this.gridData = res['data'];
          ...
          { headerName: 'Template type Identifier', field:'tmple_type_id', hide:true, alignment: 'center', cellClass: "pm-grid-number-cell", width: 100 }, 
          { headerName: 'Template type name',field: 'tmple_type_nm' , alignment: 'left', cellClass: "pm-grid-number-cell", width: 265, sortable: true,filter:true },
     ];
