...
@Component({
  selector: 'app-araType',
  templateUrl: './araType.component.html',
  styleUrls: ['./araType.component.scss']
})
export class AratypeComponent implements OnInit {
  columnDefs:any;
  gridData:any;
  initdata:any;
  gridApi;
  permissions;
   ...
   public fields: any[] = [
   { type: 'pk',name: 'ara_type_id',label: 'Area type Identifier',isCustom:false,customData:{},required: false,hidden:true },
   
    { type: 'text',name: 'ara_type_cd',label: '',isCustom:false,customData:{"route":null,"input_key":null,"key":null,"label_key":null,"label":null,"table":null},value: '',required: false,hidden:false },
    { type: 'text',name: 'ara_type_nm',label: 'Area type name',isCustom:false,customData:{"route":null,"input_key":null,"key":null,"label_key":null,"label":null,"table":null},value: '',required: false,hidden:false },
  ];
  public formDetails : any ={ 
    fnctns  :{},
    apis    :{ "sel_url":"erp/araType",
               "upd_url":"erp/araType/:ara_type_id",
               "ins_url":"erp/araType",
               "del_url":"erp/araType/:ara_type_id"},
    initdata:{ },
    fields  :this.fields,
    key_field:["ara_type_id"],
    stngs   :{ "style" :"mat",
                "saveBtn":true,
                "saveAsBtn":false,
                "closeBtn":true,
                "model_style":"right",
                "form_title":" Area Types",
                "deleteBtn":false,
                "show_lables":false,
                "oper_mode":"new"
  ...
  getCustomData(customData) {
   ...
   user: any = {
    ...
    'perm_url': 'user/permissions/ERP Area Types'
  };
    ...
    this.crdsrv.get(this.formDetails.apis.sel_url).subscribe((res) => {
      if (res['status'] == 200) {
        ...
        this.gridData = res['data'];
          ...
          { headerName: 'Area type Identifier', field:'ara_type_id', hide:true, alignment: 'center', cellClass: "pm-grid-number-cell", width: 100 },
          { headerName: 'Area type name',field: 'ara_type_nm' ,alignment: 'left', cellClass: "pm-grid-number-cell", width: 265, sortable: true,filter:true },
     ];
