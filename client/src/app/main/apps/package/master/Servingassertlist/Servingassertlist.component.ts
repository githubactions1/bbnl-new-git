...
@Component({
  selector: 'app-Servingassertlist',
  templateUrl: './Servingassertlist.component.html',
  styleUrls: ['./Servingassertlist.component.scss']
})
export class ServingassertlistComponent implements OnInit {
  columnDefs:any;
  gridData:any;
  initdata:any;
  gridApi;
  permissions;
   ...
   public fields: any[] = [
   { type: 'pk',name: 'asrt_id',label: 'Assert Identifier',isCustom:false,customData:{},required: false,hidden:true },
   
    { type: 'text',name: 'asrt_nm',label: 'Assert Name',isCustom:false,customData:{"route":null,"input_key":null,"key":null,"label_key":null,"label":null,"table":null},value: '',required: false,hidden:false },
  ];
  public formDetails : any ={ 
    fnctns  :{},
    apis    :{ "sel_url":"package/Srvngasrtlst",
               "upd_url":"package/Srvngasrtlst/:asrt_id",
               "ins_url":"package/Srvngasrtlst",
               "del_url":"package/Srvngasrtlst/:asrt_id"},
    initdata:{ },
    fields  :this.fields,
    key_field:["asrt_id"],
    stngs   :{ "style" :"mat",
  ...
  user: any = {
    ...
    'perm_url': 'user/permissions/Serving Assert'
  }
    ...
    this.crdsrv.get(this.formDetails.apis.sel_url).subscribe((res) => {
      if (res['status'] == 200) {
        ...
        this.gridData = res['data'];
          ...
          { headerName: 'Assert Identifier', field:'asrt_id', hide:true, cellStyle: { 'text-align': "center" }, cellClass: "pm-grid-number-cell", width: 100 }, 
          { headerName: 'Assert Name',field: 'asrt_nm' , cellStyle: { 'text-align': "left" }, cellClass: "pm-grid-number-cell", width: 265, sortable: true,filter:true },
     ];
