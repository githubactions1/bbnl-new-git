...
@Component({
  ...
  styleUrls: ['./genrelist.component.scss']
})
export class GenrelistComponent implements OnInit {
  ...
  permissions;
   ...
   public fields: any[] = [
   { type: 'pk',name: 'genre_id',label: 'Genre Identifier',isCustom:false,customData:{},required: false,hidden:true },
   
    { type: 'text',name: 'genre_nm',label: 'Genre Name',isCustom:false,customData:{'route':null,'input_key':null,'key':null,'label_key':null,'label':null,'table':null},value: '',required: false,hidden:false },
  ];
  public formDetails : any ={ 
    fnctns  :{},
    apis    :{ 'sel_url':'package/genrelst',
               'upd_url':'package/genrelst/:genre_id',
               'ins_url':'package/genrelst',
               'del_url':'package/genrelst/:genre_id'},
    initdata:{ },
    fields  :this.fields,
    key_field:['genre_id'],
    stngs   :{ 'style' :'mat',
  ...
  user: any = {
    ...
    'perm_url': 'user/permissions/Jouner'
  }
    ...
    this.crdsrv.get(this.formDetails.apis.sel_url).subscribe((res) => {
      if (res['status'] == 200) {
        ...
        console.log(this.gridData)
          ...
          { headerName: 'Jouner Identifier', field: 'genre_id', hide: true, alignment: 'center', cellClass: 'pm-grid-number-cell', width: 100 }, 
          { headerName: 'Jouner Name', field: 'genre_nm' , alignment: 'left', cellClass: 'pm-grid-number-cell', width: 265, sortable: true, filter: true },
