...
@Component({
  selector: 'app-pckgevoipFeatures',
  templateUrl: './pckgevoipFeatures.component.html',
  styleUrls: ['./pckgevoipFeatures.component.scss']
})
export class PckgevoipfeaturesComponent implements OnInit {
  columnDefs:any;
  gridData:any;
  initdata:any;
  gridApi;
  permissions;
   ...
   public fields: any[] = [
   { type: 'pk',name: 'ftre_id',label: 'Feature Identifier',isCustom:false,customData:{},required: false,hidden:true },
   
    { type: 'text',name: 'ftre_nm',label: 'Feature Name',isCustom:false,customData:{"route":null,"input_key":null,"key":null,"label_key":null,"label":null,"table":null},value: '',required: false,hidden:false },
    ...
    { type: 'text',name: 'ftre_cd',label: 'Feature Code',isCustom:false,customData:{"route":null,"input_key":null,"key":null,"label_key":null,"label":null,"table":null},value: '',required: false,hidden:false },
    { type: 'text',name: 'ftre_hndlr_tx',label: 'Feature Handler',isCustom:false,customData:{"route":null,"input_key":null,"key":null,"label_key":null,"label":null,"table":null},value: '',required: false,hidden:false },
    { type: 'text',name: 'mx_pr_vle_ct',label: 'Max per value count',isCustom:false,customData:{"route":null,"input_key":null,"key":null,"label_key":null,"label":null,"table":null},value: '',required: false,hidden:false },
  ];
  public formDetails : any ={ 
    fnctns  :{},
    apis    :{ "sel_url":"package/pckgevoipFeatures",
               "upd_url":"package/pckgevoipFeatures/:ftre_id",
               "ins_url":"package/pckgevoipFeatures",
               "del_url":"package/pckgevoipFeatures/:ftre_id"},
    initdata:{ },
    fields  :this.fields,
    key_field:["ftre_id"],
    stngs   :{ "style" :"mat",
                ...
                "closeBtn":true,
                "model_style":"right",
                "form_title":" Package VOIP Features",
                "deleteBtn":false,
                "show_lables":false,
                "oper_mode":"new"
  ...
  user: any = {
    ...
    'perm_url': 'user/permissions/Package Voip Features'
  }
    ...
    this.crdsrv.get(this.formDetails.apis.sel_url).subscribe((res) => {
      if (res['status'] == 200) {
        ...
        this.gridData = res['data'];
          ...
          { headerName: 'Feature Identifier', field:'ftre_id', hide:true, alignment: 'center', cellClass: "pm-grid-number-cell", width: 100 }, 
          { headerName: 'Feature Name',field: 'ftre_nm' , alignment: 'left', cellClass: "pm-grid-number-cell", width: 265, sortable: true,filter:true },
          { headerName: 'Core Service',field: 'cre_srvce_nm' , alignment: 'left', cellClass: "pm-grid-number-cell", width: 265, sortable: true,filter:true },
          { headerName: 'Feature Code',field: 'ftre_cd' , alignment: 'left', cellClass: "pm-grid-number-cell", width: 265, sortable: true,filter:true },
          { headerName: 'Feature Handler',field: 'ftre_hndlr_tx' , alignment: 'left', cellClass: "pm-grid-number-cell", width: 265, sortable: true,filter:true },
          { headerName: 'Max per value count',field: 'mx_pr_vle_ct' , alignment: 'center', cellClass: "pm-grid-number-cell", width: 265, sortable: true,filter:true },
     ];
