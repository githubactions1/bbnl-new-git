...
@Component({
  ...
  styleUrls: ['./broadcasters.component.scss']
})
export class BroadcastersComponent implements OnInit {
  ...
  permissions;
   ...
   public fields: any[] = [
   { type: 'pk',name: 'brdcr_id',label: 'Broadcaster Identifier',isCustom:false,customData:{},required: false,hidden:true },
   
    { type: 'text',name: 'brdcr_nm',label: 'Broadcaster Name',isCustom:false,customData:{"route":null,"input_key":null,"key":null,"label_key":null,"label":null,"table":null},value: '',required: false,hidden:false },
    { type: 'text',name: 'brdcr_cd',label: 'Broadcaster Name',isCustom:false,customData:{"route":null,"input_key":null,"key":null,"label_key":null,"label":null,"table":null},value: '',required: false,hidden:false },
    { type: 'text',name: 'cntct_nm',label: 'Contact person Name',isCustom:false,customData:{"route":null,"input_key":null,"key":null,"label_key":null,"label":null,"table":null},value: '',required: false,hidden:false },
    { type: 'text',name: 'cntct_ph',label: 'Contact person phone number',isCustom:false,customData:{"route":null,"input_key":null,"key":null,"label_key":null,"label":null,"table":null},value: '',required: false,hidden:false },
  ];
  public formDetails : any ={ 
    fnctns  :{},
    apis    :{ "sel_url":"package/broadcasters",
               "upd_url":"package/broadcasters/:brdcr_id",
               "ins_url":"package/broadcasters",
               "del_url":"package/broadcasters/:brdcr_id"},
    initdata:{ },
    fields  :this.fields,
    key_field:["brdcr_id"],
    stngs   :{ "style" :"mat",
  ...
  constructor(private _dsSidebarService: DsSidebarService, public crdsrv: CrudService,public atmSrv:AtomService) {
    ...
    this.crdsrv.get(this.user.perm_url).subscribe((res) => {
     ...
     if (res['status'] == 200) {
        if (res['data'].length)
        { this.permissions = res['data'][0]; this.user.permissions = res['data'][0]; }
  ...
  user: any = {
    ...
    'perm_url': 'user/permissions/Broadcaster Creation'
  }
    ...
    this.crdsrv.get(this.formDetails.apis.sel_url).subscribe((res) => {
      if (res['status'] == 200) {
        ...
        this.gridData = res['data'];
          ...
          { headerName: 'Broadcaster Identifier', field:'brdcr_id', hide:true, cellStyle: { 'text-align': "center" }, cellClass: "pm-grid-number-cell", width: 100 }, 
          { headerName: 'Broadcaster Name',field: 'brdcr_nm' , cellStyle: { 'text-align': "left" }, cellClass: "pm-grid-number-cell", width: 265, sortable: true,filter:true },
          { headerName: 'Broadcaster Name',field: 'brdcr_cd' , cellStyle: { 'text-align': "left" }, cellClass: "pm-grid-number-cell", width: 265, sortable: true,filter:true },
          { headerName: 'Contact person Name',field: 'cntct_nm' , cellStyle: { 'text-align': "left" }, cellClass: "pm-grid-number-cell", width: 265, sortable: true,filter:true },
          { headerName: 'Contact person phone number',field: 'cntct_ph' , cellStyle: { 'text-align': "left" }, cellClass: "pm-grid-number-cell", width: 265, sortable: true,filter:true },
     ];
