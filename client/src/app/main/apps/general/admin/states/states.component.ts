...
export class StatesComponent implements OnInit {
  ...
  permissions;
   ...
   public fields: any[] = [
   { type: 'pk',name: 'ste_id',label: 'State Identifier',isCustom:false,customData:{},required: false,hidden:true },
   
    { type: 'text',name: 'ste_nm',label: 'State Name',isCustom:false,customData:{"route":null,"input_key":null,"key":null,"label_key":null,"label":null,"table":null},value: '',required: false,hidden:false },
  ];
  public formDetails : any ={ 
    fnctns  :{},
    apis    :{ "sel_url":"admin/states",
               "upd_url":"admin/states/:ste_id",
               "ins_url":"admin/states",
               "del_url":"admin/states/:ste_id"},
    initdata:{ },
    fields  :this.fields,
    key_field:["ste_id"],
    stngs   :{ "style" :"mat",
  ...
  user: any = {
    ...
    'perm_url': 'user/permissions/States Creation'
  }
    ...
    this.crdsrv.get(this.formDetails.apis.sel_url).subscribe((res) => {
      if (res['status'] == 200) {
        ...
        this.gridData = res['data'];
          ...
          { headerName: 'State Identifier', field:'ste_id', hide:true, cellStyle: { 'text-align': "center" }, cellClass: "pm-grid-number-cell", width: 100 }, 
          { headerName: 'State Name',field: 'ste_nm' , cellStyle: { 'text-align': "left" }, cellClass: "pm-grid-number-cell", width: 265, sortable: true,filter:true },
     ];
