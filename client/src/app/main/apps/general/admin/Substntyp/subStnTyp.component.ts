...
@Component({
  selector: 'app-subStnTyp',
  templateUrl: './subStnTyp.component.html',
  styleUrls: ['./subStnTyp.component.scss']
})
export class SubstntypComponent implements OnInit {
  columnDefs:any;
  gridData:any;
  initdata:any;
  gridApi;
  permissions;
   ...
   public fields: any[] = [
   { type: 'pk',name: 'sbstn_type_id',label: 'Sub station Identifier',isCustom:false,customData:{},required: false,hidden:true },
   
    { type: 'text',name: 'sbstn_type_nm',label: 'Sub station Name',isCustom:false,customData:{"route":null,"input_key":null,"key":null,"label_key":null,"label":null,"table":null},value: '',required: false,hidden:false },
    { type: 'text',name: 'sbstn_type_cd',label: 'Sub station Code',isCustom:false,customData:{"route":null,"input_key":null,"key":null,"label_key":null,"label":null,"table":null},value: '',required: false,hidden:false },
  ];
  public formDetails : any ={ 
    fnctns  :{},
    apis    :{ "sel_url":"admin/subStnTyp",
               "upd_url":"admin/subStnTyp/:sbstn_type_id",
               "ins_url":"admin/subStnTyp",
               "del_url":"admin/subStnTyp/:sbstn_type_id"},
    initdata:{ },
    fields  :this.fields,
    key_field:["sbstn_type_id"],
    stngs   :{ "style" :"mat",
                "saveBtn":true,
                "saveAsBtn":false,
                "closeBtn":true,
                "model_style":"right",
                "form_title":"subStnTyp",
                "deleteBtn":false,
                "show_lables":false,
                "oper_mode":"new"
    ...
    this.crdsrv.get(this.formDetails.apis.sel_url).subscribe((res) => {
      if (res['status'] == 200) {
        ...
        this.gridData = res['data'];
          ...
          { headerName: 'Sub station Identifier', field:'sbstn_type_id', hide:true, cellStyle: { 'text-align': "center" }, cellClass: "pm-grid-number-cell", width: 100 }, 
          { headerName: 'Sub station Name',field: 'sbstn_type_nm' , cellStyle: { 'text-align': "left" }, cellClass: "pm-grid-number-cell", width: 265, sortable: true,filter:true },
          { headerName: 'Sub station Code',field: 'sbstn_type_cd' , cellStyle: { 'text-align': "left" }, cellClass: "pm-grid-number-cell", width: 265, sortable: true,filter:true },
     ];
