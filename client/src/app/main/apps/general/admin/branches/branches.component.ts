...
export class BranchesComponent implements OnInit {
  ...
  permissions;
   ...
   public fields: any[] = [
   { type: 'pk',name: 'otlt_id',label: 'Identifier',isCustom:false,customData:{},required: false,hidden:true },
   
    { type: 'text',name: 'otlt_nm',label: 'Outlet Name',isCustom:false,customData:{"route":null,"input_key":null,"key":null,"label_key":null,"label":null,"table":null},value: '',required: false,hidden:false },  
    { type: 'textarea',name: 'otlt_cd',label: '',isCustom:false,customData:{"route":null,"input_key":null,"key":null,"label_key":null,"label":null,"table":null},multiline:true,rowcount:6,value: '',required: false,hidden:false },
    { type: 'dropdown',name: 'otlt_ctgry_id',label: '',isCustom:true,customData:{"route":"admin//branchCategory","input_key":null,"key":"otlt_ctgry_id","label_key":"otlt_ctgry_nm","label":null,"table":"mrcht_otlt_ctgry_lst_t"},value: '',required: false,hidden:false },
  ];
  public formDetails : any ={ 
    fnctns  :{},
    apis    :{ "sel_url":"admin/branches",
               "upd_url":"admin/branches/:otlt_id",
               "ins_url":"admin/branches",
               "del_url":"admin/branches/:otlt_id"},
    initdata:{ },
    fields  :this.fields,
    key_field:["otlt_id"],
    stngs   :{ "style" :"mat",
  ...
  user: any = {
    ...
    'perm_url': 'user/permissions/Branch Creation'
  }
    ...
    this.crdsrv.get(this.formDetails.apis.sel_url).subscribe((res) => {
      if (res['status'] == 200) {
        ...
        this.gridData = res['data'];
          ...
          { headerName: 'Identifier', field:'otlt_id', hide:true, alignment: 'center', cellClass: "pm-grid-number-cell", width: 100 }, 
          { headerName: 'Outlet Name',field: 'otlt_nm' , alignment: 'left', cellClass: "pm-grid-number-cell", width: 265, sortable: true,filter:true },
          // { headerName: '',field: 'otlt_cd' , alignment: 'left', cellClass: "pm-grid-number-cell", width: 265, sortable: true,filter:true },
          { headerName: 'Outlet Category',field: 'otlt_ctgry_nm' , alignment: 'left', cellClass: "pm-grid-number-cell", width: 265, sortable: true,filter:true },
     ];
