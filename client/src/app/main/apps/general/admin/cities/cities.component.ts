...
export class CitiesComponent implements OnInit {
  ...
  permissions;
   ...
   public fields: any[] = [
   { type: 'pk',name: 'cty_id',label: 'City Identifier',isCustom:false,customData:{},required: false,hidden:true },
    ...
    { type: 'text',name: 'cty_nm',label: 'city name',isCustom:false,customData:{"route":null,"input_key":null,"key":null,"label_key":null,"label":null,"table":null},value: '',required: false,hidden:false },
  ];
  public formDetails : any ={ 
    fnctns  :{},
    apis    :{ "sel_url":"admin/cities",
               "upd_url":"admin/cities/:cty_id",
               "ins_url":"admin/cities",
               "del_url":"admin/cities/:cty_id"},
    initdata:{ },
    fields  :this.fields,
    key_field:["cty_id"],
    stngs   :{ "style" :"mat",
  ...
  user: any = {
    ...
    'perm_url': 'user/permissions/Cities Creation'
  }
    ...
    this.crdsrv.get(this.formDetails.apis.sel_url).subscribe((res) => {
      if (res['status'] == 200) {
        ...
        this.gridData = res['data'];
          ...
          { headerName: 'City Identifier', field:'cty_id', hide:true, cellStyle: { 'text-align': "center" }, cellClass: "pm-grid-number-cell", width: 100 }, 
          ...
          { headerName: 'city name',field: 'cty_nm' , cellStyle: { 'text-align': "left" }, cellClass: "pm-grid-number-cell", width: 265, sortable: true,filter:true },
     ];
