...
export class TicketSourceComponent implements OnInit {
  ...
  permissions;
   ...
   public fields: any[] = [
   { type: 'pk',name: 'tckt_srce_id',label: 'Ticket source Identifier',isCustom:false,customData:{},required: false,hidden:true },
   
    { type: 'text',name: 'tckt_srce_nm',label: 'Ticket source Name',isCustom:false,customData:{"route":null,"input_key":null,"key":null,"label_key":null,"label":null,"table":null},value: '',required: false,hidden:false },
    { type: 'text',name: 'tckt_srce_cd',label: 'Ticket source Code',isCustom:false,customData:{"route":null,"input_key":null,"key":null,"label_key":null,"label":null,"table":null},value: '',required: false,hidden:false },
  ];
  public formDetails : any ={ 
    fnctns  :{},
    apis    :{ "sel_url":"support/Ticket-Source",
               "upd_url":"support/Ticket-Source/:tckt_srce_id",
               "ins_url":"support/Ticket-Source",
               "del_url":"support/Ticket-Source/:tckt_srce_id"},
    initdata:{ },
    fields  :this.fields,
    key_field:["tckt_srce_id"],
    stngs   :{ "style" :"mat",
                "saveBtn":true,
                "saveAsBtn":false,
                "closeBtn":true,
                "model_style":"right",
                "form_title":"Ticket-Source",
                "deleteBtn":false,
                "show_lables":false,
                "oper_mode":"new"
    ...
    this.crdsrv.get(this.formDetails.apis.sel_url).subscribe((res) => {
      if (res['status'] == 200) {
        ...
        this.gridData = res['data'];
          this.columnDefs = [
          { headerName: 'Sno', field: 'sno', alignment: 'center', cellClass: "pm-grid-number-cell", width: 100, sortable: true, search: false, filter: false },
          { headerName: 'Ticket source Identifier', field: 'tckt_srce_id', hide: true, alignment: 'center', cellClass: "pm-grid-number-cell", width: 100 }, 
          { headerName: 'Ticket source Name', field: 'tckt_srce_nm' , alignment: 'left', cellClass: "pm-grid-number-cell", width: 265, sortable: true, filter: true },
          { headerName: 'Ticket source Code', field: 'tckt_srce_cd' , alignment: 'left', cellClass: "pm-grid-number-cell", width: 265, sortable: true, filter: true },
     ];
