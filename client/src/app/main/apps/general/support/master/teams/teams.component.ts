...
export class TeamsComponent implements OnInit {
  ...
  permissions;
   ...
   public fields: any[] = [
   { type: 'pk',name: 'tm_id',label: 'Support Team Identifier',isCustom:false,customData:{},required: false,hidden:true },
   
    { type: 'text',name: 'tm_nm',label: 'Support Team Name',isCustom:false,customData:{"route":null,"input_key":null,"key":null,"label_key":null,"label":null,"table":null},value: '',required: false,hidden:false },  
    { type: 'text',name: 'tm_dscn_tx',label: 'Support Team  description',isCustom:false,customData:{"route":null,"input_key":null,"key":null,"label_key":null,"label":null,"table":null},multiline:true,rowcount:6,value: '',required: false,hidden:false },
  ];
  public formDetails : any ={ 
    fnctns  :{},
    apis    :{ "sel_url":"support/Team",
               "upd_url":"support/Team/:tm_id",
               "ins_url":"support/Team",
               "del_url":"support/Team/:tm_id"},
    initdata:{ },
    fields  :this.fields,
    key_field:["tm_id"],
    stngs   :{ "style" :"mat",
    ...
    this.crdsrv.get(this.formDetails.apis.sel_url).subscribe((res) => {
      if (res['status'] == 200) {
        ...
        this.gridData = res['data'];
          ...
          { headerName: 'Support Team Identifier', field:'tm_id', hide:true, alignment: 'center', cellClass: "pm-grid-number-cell", width: 100 }, 
          { headerName: 'Support Team Name',field: 'tm_nm' ,alignment: 'left', cellClass: "pm-grid-number-cell", width: 265, sortable: true,filter:true },
          { headerName: 'Support Team  description',field: 'tm_dscn_tx' ,alignment: 'left', cellClass: "pm-grid-number-cell", width: 265, sortable: true,filter:true },
     ];
