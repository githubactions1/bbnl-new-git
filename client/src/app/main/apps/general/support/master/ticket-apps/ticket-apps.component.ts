...
@Component({
  selector: 'app-ticket-apps',
  templateUrl: './ticket-apps.component.html',
  styleUrls: ['./ticket-apps.component.scss']
})
export class TicketAppsComponent implements OnInit {
  columnDefs:any;
  gridData:any;
  initdata:any;
  gridApi;
  permissions;
   ...
   public fields: any[] = [
   { type: 'pk',name: 'aplctn_id',label: 'Application Identifier',isCustom:false,customData:{},required: false,hidden:true },
   
    { type: 'text',name: 'aplctn_nm',label: 'Application Name',isCustom:false,customData:{"route":null,"input_key":null,"key":null,"label_key":null,"label":null,"table":null},value: '',required: false,hidden:false },
    { type: 'text',name: 'aplctn_cd',label: 'Application Code',isCustom:false,customData:{"route":null,"input_key":null,"key":null,"label_key":null,"label":null,"table":null},value: '',required: false,hidden:false },
  ];
  public formDetails : any ={ 
    fnctns  :{},
    apis    :{ "sel_url":"support/Application",
               "upd_url":"support/Application/:aplctn_id",
               "ins_url":"support/Application",
               "del_url":"support/Application/:aplctn_id"},
    initdata:{ },
    fields  :this.fields,
    key_field:["aplctn_id"],
    stngs   :{ "style" :"mat",
    ...
    this.crdsrv.get(this.formDetails.apis.sel_url).subscribe((res) => {
      if (res['status'] == 200) {
        ...
        this.gridData = res['data'];
          ...
          { headerName: 'Application Identifier', field:'aplctn_id', hide:true, alignment: 'center', cellClass: "pm-grid-number-cell", width: 100 }, 
          { headerName: 'Application Name',field: 'aplctn_nm' , alignment: 'left', cellClass: "pm-grid-number-cell", width: 265, sortable: true,filter:true },
          { headerName: 'Application Code',field: 'aplctn_cd' , alignment: 'left', cellClass: "pm-grid-number-cell", width: 265, sortable: true,filter:true },
     ];
