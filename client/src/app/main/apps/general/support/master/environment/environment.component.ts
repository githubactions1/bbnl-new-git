...
export class EnvironmentComponent implements OnInit {
  ...
  permissions;
   ...
   public fields: any[] = [
   { type: 'pk',name: 'env_id',label: 'Environment Identifier',isCustom:false,customData:{},required: false,hidden:true },
   
    { type: 'text',name: 'env_nm',label: 'Environment Name',isCustom:false,customData:{"route":null,"input_key":null,"key":null,"label_key":null,"label":null,"table":null},value: '',required: false,hidden:false },
    { type: 'text',name: 'env_cd',label: 'Environment Code',isCustom:false,customData:{"route":null,"input_key":null,"key":null,"label_key":null,"label":null,"table":null},value: '',required: false,hidden:false },
  ];
  public formDetails : any ={ 
    fnctns  :{},
    apis    :{ "sel_url":"support/Environment",
               "upd_url":"support/Environment/:env_id",
               "ins_url":"support/Environment",
               "del_url":"support/Environment/:env_id"},
    initdata:{ },
    fields  :this.fields,
    key_field:["env_id"],
    stngs   :{ "style" :"mat",
    ...
    this.crdsrv.get(this.formDetails.apis.sel_url).subscribe((res) => {
      if (res['status'] == 200) {
        ...
        this.gridData = res['data'];
          ...
          { headerName: 'Environment Identifier', field:'env_id', hide:true, alignment: 'center', cellClass: "pm-grid-number-cell", width: 100 }, 
          { headerName: 'Environment Name',field: 'env_nm' , alignment: 'left', cellClass: "pm-grid-number-cell", width: 265, sortable: true,filter:true },
          { headerName: 'Environment Code',field: 'env_cd' , alignment: 'left', cellClass: "pm-grid-number-cell", width: 265, sortable: true,filter:true },
     ];
