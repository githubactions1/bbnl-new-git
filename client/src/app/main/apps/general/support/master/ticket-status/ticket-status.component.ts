...
export class TicketStatusComponent implements OnInit {
  ...
  permissions;
   ...
   public fields: any[] = [
   { type: 'pk',name: 'tckt_sts_id',label: 'Ticket Status Identifier',isCustom:false,customData:{},required: false,hidden:true },
   
    { type: 'text',name: 'tckt_sts_nm',label: 'Ticket Status Name',isCustom:false,customData:{"route":null,"input_key":null,"key":null,"label_key":null,"label":null,"table":null},value: '',required: false,hidden:false },
    // { type: 'text',name: 'tckt_type_cd',label: 'Ticket Status Code',isCustom:false,customData:{"route":null,"input_key":null,"key":null,"label_key":null,"label":null,"table":null},value: '',required: false,hidden:false },
  ];
  public formDetails : any ={ 
    fnctns  :{},
    apis    :{ "sel_url":"support/Ticket-Status",
               "upd_url":"support/Ticket-Status/:tckt_sts_id",
               "ins_url":"support/Ticket-Status",
               "del_url":"support/Ticket-Status/:tckt_sts_id"},
    initdata:{ },
    fields  :this.fields,
    key_field:["tckt_sts_id"],
    stngs   :{ "style" :"mat",
                "saveBtn":true,
                "saveAsBtn":false,
                "closeBtn":true,
                "model_style":"right",
                "form_title":"Ticket-Status",
                "deleteBtn":false,
                "show_lables":false,
                "oper_mode":"new"
    ...
    this.crdsrv.get(this.formDetails.apis.sel_url).subscribe((res) => {
      if (res['status'] == 200) {
        ...
        this.gridData = res['data'];
          ...
          { headerName: 'Ticket Status Identifier', field:'tckt_sts_id', hide:true, alignment: 'center', cellClass: "pm-grid-number-cell", width: 100 }, 
          { headerName: 'Ticket Status Name',field: 'tckt_sts_nm' , alignment: 'left', cellClass: "pm-grid-number-cell", width: 265, sortable: true,filter:true },
     ];
