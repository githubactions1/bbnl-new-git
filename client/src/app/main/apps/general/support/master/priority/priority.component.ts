...
export class PriorityComponent implements OnInit {
  ...
  permissions;
   ...
   public fields: any[] = [
   { type: 'pk',name: 'prty_id',label: 'Priority Identifier',isCustom:false,customData:{},required: false,hidden:true },
   
    { type: 'text',name: 'prty_nm',label: 'Priority Name',isCustom:false,customData:{"route":null,"input_key":null,"key":null,"label_key":null,"label":null,"table":null},value: '',required: false,hidden:false },
  ];
  public formDetails : any ={ 
    fnctns  :{},
    apis    :{ "sel_url":"support/Priority",
               "upd_url":"support/Priority/:prty_id",
               "ins_url":"support/Priority",
               "del_url":"support/Priority/:prty_id"},
    initdata:{ },
    fields  :this.fields,
    key_field:["prty_id"],
    stngs   :{ "style" :"mat",
    ...
    this.crdsrv.get(this.formDetails.apis.sel_url).subscribe((res) => {
      if (res['status'] == 200) {
        ...
        this.gridData = res['data'];
          ...
          { headerName: 'Priority Identifier', field:'prty_id', hide:true, alignment: 'center', cellClass: "pm-grid-number-cell", width: 100 }, 
          { headerName: 'Priority Name',field: 'prty_nm' , alignment: 'left', cellClass: "pm-grid-number-cell", width: 265, sortable: true,filter:true },
     ];
