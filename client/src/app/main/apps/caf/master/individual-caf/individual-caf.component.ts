...
@Component({
  selector: 'app-individual-caf',
  templateUrl: './individual-caf.component.html',
  styleUrls: ['./individual-caf.component.scss']
})
export class IndividualCafComponent implements OnInit {
  pckgeProperties: any
