...
@Component({
  selector: 'app-EntrpeCstmrTyp',
  templateUrl: './EntrpeCstmrTyp.component.html',
  styleUrls: ['./EntrpeCstmrTyp.component.scss']
})
export class EntrpecstmrtypComponent implements OnInit {
  columnDefs:any;
  gridData:any;
  initdata:any;
  gridApi;
  permissions;
   ...
   public fields: any[] = [
   { type: 'pk',name: 'entrpe_type_id',label: 'Enterprise Customer Type Identifier',isCustom:false,customData:{},required: false,hidden:true },
   
    { type: 'text',name: 'entrpe_type_nm',label: 'Enterprise Customer Type Name',isCustom:false,customData:{"route":null,"input_key":null,"key":null,"label_key":null,"label":null,"table":null},value: '',required: false,hidden:false },
  ];
  public formDetails : any ={ 
    fnctns  :{},
    apis    :{ "sel_url":"caf/EntrpeCstmrTyp",
               "upd_url":"caf/EntrpeCstmrTyp/:entrpe_type_id",
               "ins_url":"caf/EntrpeCstmrTyp",
               "del_url":"caf/EntrpeCstmrTyp/:entrpe_type_id"},
    initdata:{ },
    fields  :this.fields,
    key_field:["entrpe_type_id"],
    stngs   :{ "style" :"mat",
                "saveBtn":true,
                "saveAsBtn":false,
                "closeBtn":true,
                "model_style":"right",
                "form_title":" Enterprise Customer Types",
                "deleteBtn":false,
                "show_lables":false,
                "oper_mode":"new"
  ...
  user: any = {
    ...
    'perm_url': 'user/permissions/Enterprise Customer Type List'
  }
    ...
    this.crdsrv.get(this.formDetails.apis.sel_url).subscribe((res) => {
      if (res['status'] == 200) {
        ...
        this.gridData = res['data'];
          ...
          { headerName: 'Enterprise Customer Type Identifier', field:'entrpe_type_id', hide:true, alignment: 'center', cellClass: "pm-grid-number-cell", width: 100 }, 
          { headerName: 'Enterprise Customer Type Name',field: 'entrpe_type_nm' , alignment: 'left', cellClass: "pm-grid-number-cell", width: 265, sortable: true,filter:true },
     ];
