...
@Component({
  selector: 'app-cafbulkform',
  templateUrl: './cafbulkform.component.html',
  styleUrls: ['./cafbulkform.component.scss']
})
export class CafbulkformComponent implements OnInit {
  pckgeProperties: any
  ...
  ngOnInit() {
    ...
    this.blckupldata=this.TransfereService.getData()
    ...
    //  this.getcstmrtyp()
  //  if(this.blckupldata){
  //   this.firstFormGroup.get('custInfo').get('frst_nm').setValue(this.blckupldata.frst_nm);
  //   this.firstFormGroup.get('custInfo').get('blng_cntct_nm').setValue(this.blckupldata.contct_nm);
  //   this.firstFormGroup.get('custInfo').get('mbl_nu').setValue(this.blckupldata.contct_mb_nu);
  //   this.firstFormGroup.get('custInfo').get('blng_eml1_tx').setValue(this.blckupldata.email);
  //   this.firstFormGroup.get('custInfo').get('loc_lmdle1_nu').setValue(this.blckupldata.contct_mb_nu);
  //   if(this.siusr){
    
  //   this.firstFormGroup.get('custInfo').get('instl_state').setValue(1);
  //   this.firstFormGroup.get('custInfo').get('loc_dstrct_id').setValue(this.blckupldata.dstrt_id);
  //   this.firstFormGroup.get('custInfo').get('loc_mndl_id').setValue(this.blckupldata.mndl_id);
  //   this.firstFormGroup.get('custInfo').get('loc_vlge_id').setValue(this.blckupldata.vlge_id);
  //   this.getsiusrpop()
  //   this.vlgnm = this.blckupldata.vlge_nm
  //   this.distnm = this.blckupldata.dstrct_nm
  //   this.mandalnm = this.blckupldata.mndl_nm
  //   }
  //  }
  ...
  getSlotDetailsForPort() {
    ...
    this.crdsrv.get(rte).subscribe((res) => {
      if (res['data'].length == 0) {
        this.snackBar.open("No ports are empty", '', {
          duration: 2000,
          horizontalPosition: this.horizontalPosition,
          verticalPosition: this.verticalPosition,
        });
  ...
  getpackages() {
    ...
    if(this.usrdtls.prt_in ==2){
      this.caftyp_id = 2
      const rte = `package/getPckgesByAgntId/101000008/` + this.caftyp_id;
      console.log(rte)
      this.crdsrv.get(rte).subscribe((res) => {
      ...
      const rte = `package/getPckgesById/` + this.blckupldata.crnt_pln_id;
      console.log(rte)
      this.crdsrv.get(rte).subscribe((res) => {
        this.packages = res['data'];
        this.getpackagedta(this.packages[0])
        console.log(res['data'])
        console.log(this.packages)
  ...
  getPackagedtl(data) {
    ...
    if(this.blckupldata){
      this.firstFormGroup.get('crnt_pckge_id').setValue(this.blckupldata.crnt_pckge_id)
     }
  }
  getpackagedta(data) {
  ...
  newentry() {
    ...
    data["instl_dstrt_id"]= this.firstFormGroup.value.custInfo.loc_mndl_id,
   ...
   // data["olt_prt_nm"] = this.lagDtls.olt_prt_nm
    ...
    data["blck_upld_Dtls"]=this.blckupldata
    console.log(data)
    this.crdsrv.create(data, rte).subscribe((res) => {
      console.log(res);
      if (res['status'] == 200) {
  ...
  //     caf_nu: this.cafid,
  //     agnt_id: '',
  //     cstmr_fst_nm: this.firstFormGroup.value.frst_nm,
  ...
  //     cstmr_dtf_brth: this.firstFormGroup.value.dob_dt,
  //     cstmr_fthr_hsbd_nm: this.firstFormGroup.value.father_husbandname,
  //     adhr_nu: this.firstFormGroup.value.adhr_nu,
  //     pan_nu: this.firstFormGroup.value.pan_card_no,
  //     cstmr_emle_tx: this.firstFormGroup.value.loc_eml1_tx,
  //     cstmr_mble_nu: this.firstFormGroup.value.loc_lmdle1_nu,
  //     blng_frqny_id: this.firstFormGroup.value.frqncy_id,
  //     actvtn_dt: this.firstFormGroup.value.actvn_dt,
  ...
  //     instl_lclty_tx: this.firstFormGroup.value.loc_lcly_tx,
  //     instl_pn_cd: this.firstFormGroup.value.instl_pincode,
  //     instl_ste_id: this.firstFormGroup.value.instl_state,
  //     instl_dstrt_id: this.firstFormGroup.value.loc_dstrct_id,
  //     instl_mndle_id: this.firstFormGroup.value.loc_mndl_id,
  //     instl_cty_id: this.firstFormGroup.value.loc_vlge_id,
  //     instl_lat: this.firstFormGroup.value.instl_latitude,
  //     instl_lng: this.firstFormGroup.value.instl_longitude,
  //     cntct_prsn_nm: this.firstFormGroup.value.blng_cntct_nm,
  //     cntct_prsn_mble_nu: this.firstFormGroup.value.mbl_nu,
  //     cntct_prsn_emle_tx: this.firstFormGroup.value.blng_eml1_tx,
  ...
  //     blng_lclty_tx: this.firstFormGroup.value.blng_lcly_tx,
  //     blng_pn_cd: this.firstFormGroup.value.blng_pn_cd,
  //     blng_ste_id: this.firstFormGroup.value.blng_ste_id,
  //     blng_dstrt_id: this.firstFormGroup.value.blng_dstrct_id,
  //     blng_mndle_id: this.firstFormGroup.value.blng_mndl_id,
  //     blng_cty_id: this.firstFormGroup.value.blng_vlge_id,
