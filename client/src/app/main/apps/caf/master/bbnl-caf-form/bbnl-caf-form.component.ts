...
@Component({
  selector: 'app-bbnl-caf-form',
  templateUrl: './bbnl-caf-form.component.html',
  styleUrls: ['./bbnl-caf-form.component.scss']
})
export class BbnlCafFormComponent implements OnInit {
  ...
  getHeaderDtls = function () { return { "title": 'BBNL Add New CAF', "icon": "people_outline" } }
  blng_frqncy_lst: any;
  mndal_lst: any;
  mandalId: any;
  vilge_lst: any;
  ...
  constructor(private _dsSidebarService: DsSidebarService, private http: HttpClient, private router: Router, private _formBuilder: FormBuilder, private crdsrv: CrudService, private datePipe: DatePipe, private snackBar: MatSnackBar, public dialog: MatDialog, public TransfereService: TransfereService) {
    ...
    const permTxt = 'BBNL Enterprise CAF Creation';
