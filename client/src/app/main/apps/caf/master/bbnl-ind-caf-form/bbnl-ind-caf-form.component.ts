...
@Component({
  selector: 'app-bbnl-ind-caf-form',
  templateUrl: './bbnl-ind-caf-form.component.html',
  styleUrls: ['./bbnl-ind-caf-form.component.scss']
})
export class BbnlIndCafFormComponent implements OnInit {
  ...
  getHeaderDtls = function () { return { "title": 'Add BBNL New CAF', "icon": "people_outline" } }
  blng_frqncy_lst: any;
  mndal_lst: any;
  mandalId: any;
  vilge_lst: any;
  ...
  ngOnInit() {
    ...
    if (this.frmData == undefined) {
      ...
      this.getHeaderDtls = function () { return { "title": 'Add BBNL New CAF', "icon": "people_outline" } }
    }
      ...
      //this.firstFormGroup.get('department_id').setValidators(null)
