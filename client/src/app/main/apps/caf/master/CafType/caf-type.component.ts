...
@Component({
  selector: 'app-caf-type',
  templateUrl: './caf-type.component.html',
  styleUrls: ['./caf-type.component.scss']
})
export class CafTypeComponent implements OnInit {
  columnDefs:any;
  gridData:any;
  initdata:any;
  gridApi;
  permissions;
   ...
   public fields: any[] = [
   { type: 'pk',name: 'caf_type_id',label: 'CAF Type Identifier',isCustom:false,customData:{},required: false,hidden:true },
   
    { type: 'text',name: 'caf_type_nm',label: 'CAF Type Name',isCustom:false,customData:{"route":null,"input_key":null,"key":null,"label_key":null,"label":null,"table":null},value: '',required: false,hidden:false },
  ];
  public formDetails : any ={ 
    fnctns  :{},
    apis    :{ "sel_url":"caf/caf-type",
               "upd_url":"caf/caf-type/:caf_type_id",
               "ins_url":"caf/caf-type",
               "del_url":"caf/caf-type/:caf_type_id"},
    initdata:{ },
    fields  :this.fields,
    key_field:["caf_type_id"],
    stngs   :{ "style" :"mat",
                "saveBtn":true,
                "saveAsBtn":false,
                "closeBtn":true,
                "model_style":"right",
                "form_title":" CAF Types",
                "deleteBtn":false,
                "show_lables":false,
                "oper_mode":"new"
  ...
  user: any = {
    ...
    'perm_url': 'user/permissions/CAF Type'
  }
    ...
    this.crdsrv.get(this.formDetails.apis.sel_url).subscribe((res) => {
      if (res['status'] == 200) {
        ...
        this.gridData = res['data'];
          ...
          { headerName: 'CAF Type Identifier', field:'caf_type_id', hide:true, alignment: 'center', cellClass: "pm-grid-number-cell", width: 100 }, 
          { headerName: 'CAF Type Name',field: 'caf_type_nm' , alignment: 'left', cellClass: "pm-grid-number-cell", width: 265, sortable: true,filter:true },
     ];
