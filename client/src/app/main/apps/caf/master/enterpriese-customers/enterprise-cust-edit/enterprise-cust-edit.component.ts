...
@Component({
  selector: 'app-enterprise-cust-edit',
  templateUrl: './enterprise-cust-edit.component.html',
  styleUrls: ['./enterprise-cust-edit.component.scss']
})
export class EnterpriseCustEditComponent implements OnInit {
  pckgeProperties: any
  ...
  getHeaderDtls = function () { return { "title": 'Update Enterprise Customer', "icon": "people_outline" } }
  blng_frqncy_lst: any;
  mndal_lst: any;
  mandalId: any;
  vilge_lst: any;
