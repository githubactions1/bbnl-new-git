...
@Component({
  selector: 'app-caf-event-status',
  templateUrl: './caf-event-status.component.html',
  styleUrls: ['./caf-event-status.component.scss']
})
export class CafEventStatusComponent implements OnInit {
  columnDefs:any;
  gridData:any;
  initdata:any;
  gridApi;
  permissions;
   ...
   public fields: any[] = [
   { type: 'pk',name: 'caf_evnt_sts_id',label: 'CAF event status Identifier',isCustom:false,customData:{},required: false,hidden:true },
   
    { type: 'text',name: 'caf_evnt_sts_nm',label: 'CAF event status name',isCustom:false,customData:{"route":null,"input_key":null,"key":null,"label_key":null,"label":null,"table":null},value: '',required: false,hidden:false },
    { type: 'text',name: 'caf_evnt_sts_cd',label: 'CAF event status code',isCustom:false,customData:{"route":null,"input_key":null,"key":null,"label_key":null,"label":null,"table":null},value: '',required: false,hidden:false },  
    { type: 'textarea',name: 'caf_evnt_sts_dscn_tx',label: 'CAF event status description',isCustom:false,customData:{"route":null,"input_key":null,"key":null,"label_key":null,"label":null,"table":null},multiline:true,rowcount:6,value: '',required: false,hidden:false },
  ];
  public formDetails : any ={ 
    fnctns  :{},
    apis    :{ "sel_url":"caf/caf-event-status",
               "upd_url":"caf/caf-event-status/:caf_evnt_sts_id",
               "ins_url":"caf/caf-event-status",
               "del_url":"caf/caf-event-status/:caf_evnt_sts_id"},
    initdata:{ },
    fields  :this.fields,
    key_field:["caf_evnt_sts_id"],
    stngs   :{ "style" :"mat",
                "saveBtn":true,
                "saveAsBtn":false,
                "closeBtn":true,
                "model_style":"right",
                "form_title":" CAF Event Status",
                "deleteBtn":false,
                "show_lables":false,
                "oper_mode":"new"
  ...
  user: any = {
    ...
    'perm_url': 'user/permissions/CAF Event Status'
  }
    ...
    this.crdsrv.get(this.formDetails.apis.sel_url).subscribe((res) => {
      if (res['status'] == 200) {
        ...
        this.gridData = res['data'];
          ...
          { headerName: 'CAF event status Identifier', field:'caf_evnt_sts_id', hide:true, alignment: 'center', cellClass: "pm-grid-number-cell", width: 100 }, 
          { headerName: 'CAF event status name',field: 'caf_evnt_sts_nm' , alignment: 'left', cellClass: "pm-grid-number-cell", width: 265, sortable: true,filter:true },
          { headerName: 'CAF event status code',field: 'caf_evnt_sts_cd' , alignment: 'left', cellClass: "pm-grid-number-cell", width: 265, sortable: true,filter:true },
          { headerName: 'CAF event status description',field: 'caf_evnt_sts_dscn_tx' , alignment: 'left', cellClass: "pm-grid-number-cell", width: 265, sortable: true,filter:true },
     ];
