...
@Component({
    selector     : 'ds-theme-options',
    templateUrl  : './theme-options.component.html',
    styleUrls    : ['./theme-options.component.scss'],
    encapsulation: ViewEncapsulation.None,
    animations   : dsAnimations
})
export class DsThemeOptionsComponent implements OnInit, OnDestroy
{
    dsConfig: any;
    form: FormGroup;
    ...
    ngOnInit(): void
    {
        ...
        this.form.valueChanges
            ...
            .subscribe((config) => {
                ...
                // Update the config
                this._dsConfigService.config = config;
            });
        ...
        // this._dsNavigationService.addNavigationItem(customFunctionNavItem, 'end');
    }
    ...
    ngOnDestroy(): void
    {
        ...
        this._dsNavigationService.removeNavigationItem('custom-function');
    }
            ...
            case 'vertical-layout-1':
            {
                this.form.patchValue({
                    layout: {
                        width    : 'fullwidth',
                        navbar   : {
                            primaryBackground  : 'ds-navy-contrast-400',
                            secondaryBackground: 'ds-navy-600',
                            folded             : false,
                            hidden             : false,
                            position           : 'left',
                        ...
                        toolbar  : {
                            background           : 'ds-white-500',
                            customBackgroundColor: false,
                            hidden               : false,
                            position             : 'below-static'
                        },
                        footer   : {
                            background           : 'ds-navy-600',
