...
export class DsWidgetComponent implements AfterContentInit
{
    @HostBinding('class.flipped')
    flipped = false;

    @ContentChildren(DsWidgetToggleDirective, {descendants: true})
    toggleButtons: QueryList<DsWidgetToggleDirective>;
