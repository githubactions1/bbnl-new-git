...
import { DsSidebarService } from './sidebar.service';
...
export class DsSidebarComponent implements OnInit, OnDestroy
{
    ...
    ngOnInit(): void
    {
        ...
        this._dsConfigService.config
            ...
            .subscribe((config) => {
                this._dsConfig = config;
            });

        // Register the sidebar
        this._dsSidebarService.register(this.name, this);
    ...
    ngOnDestroy(): void
    {
        ...
        this._dsSidebarService.unregister(this.name);
    ...
    private _showBackdrop(): void
    {
        ...
        this._backdrop.classList.add('ds-sidebar-overlay');

        // Add a class depending on the invisibleOverlay option
        if ( this.invisibleOverlay )
        {
            this._backdrop.classList.add('ds-sidebar-overlay-invisible');
        }
