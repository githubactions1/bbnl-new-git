...
export class DsInnerScrollDirective implements OnInit, OnDestroy
{
    // Private
    private _parent: any;
     ...
     * @param {DsMatchMediaService} _dsMediaMatchService
     * @param {Renderer2} _renderer
     */
    constructor(
        private _elementRef: ElementRef,
        private _dsMediaMatchService: DsMatchMediaService,
    ...
    ngOnInit(): void
    {
        ...
        this._dsMediaMatchService.onMediaChange
